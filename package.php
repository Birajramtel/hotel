...
<head>
    ...
    <title>Naava Resort | Package</title>
</head>

<body>
    <!-- Header Opened -->
    <!-- NavBar started -->
    <?php $page = "package"; include('include/header.php') ?>
    <!-- Banner Image  -->
    <div class="about_cover">
        ...
        <div class="container about_breadcrumb d-none d-md-block">
            <h2 class="header_2 text-white"><strong><b>Package</b></strong> </h2>
            <ul class="breadcrumb pl-1">
                <li><a href="index.php">Home </a></li>
                <li><a href="accommodation.php">Package</a></li>
            </ul>
        </div>
    </div>
    <!-- Header Closed -->
